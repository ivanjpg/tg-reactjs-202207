...
class RelojEstado extends React.Component {
  ...
  // Este método se ejecuta automáticamente ANTES de «despintar»
  // y destruir el componente.
  componentWillUnmount() {
    // Este es el lugar apropiado para detener el timer, entonces
    // lo hacemos usando el identificador que «setInterval()» nos
    // devolvió cuando lo iniciamos.
